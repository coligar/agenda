...
const setInputValues = (data:any, setValue:UseFormSetValue<IFormPersonalDataInput>) =>
{
    ...
    if(data || data !== undefined)
    {
        ...
        setValue("area_activityId", (data.area_activityId) ? data.area_activityId : '')
        ...
        setValue("address", (data.address.length > 0) ? data.address[0].address : '')
        setValue("number", (data.address.length > 0) ?  data.address[0].number : '')
        setValue("complement", (data.address.length > 0) ? data.address[0].complement : '')
        setValue("district", (data.address.length > 0) ? data.address[0].district : '')
        setValue("city", (data.address.length > 0) ? data.address[0].city : '')
        setValue("uf", (data.address.length > 0) ? data.address[0].uf : '')
        setValue("phone", (data.phone_contact.length > 0) ? data.phone_contact[0].phone : '')
    }
}
